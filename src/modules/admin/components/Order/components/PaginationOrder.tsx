    ...
    <div className='flex flex-col md:flex-row justify-between items-center mt-6 px-4 py-4 bg-white rounded-xl shadow-sm border border-gray-100'>
      ...
      <div className='flex items-center space-x-2 mb-4 md:mb-0'>
        <Button
          ...
          className='h-8 w-8 rounded-md border-gray-200 bg-white text-gray-500 hover:bg-orange-50 hover:border-orange-300 hover:text-orange-600 disabled:bg-gray-50 disabled:text-gray-400 cursor-pointer'
        >
      ...
      <div className='text-sm font-medium text-gray-700'>
        ...
        trên <span className='text-orange-500 font-semibold'>{totalItems}</span> kết quả
      </div>
    </div>
  );
}
